            ...
            <div class="w-full mx-4">
                ...
                <div class="flex items-center justify-between mt-6">
                    ...
                    <div
                        ...
                        <div cla
                             @click="isOpen= !isOpen"
                             ss="bg-gray-200 text-xxs font-bold uppercase loading-none
                        ...
                        <button
                            ...
                            <svg width="16" height="16" fill="currentColor" class="bi bi-three-dots" viewBox="0 0 16 16"> <path d="M3 9.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z" style="color: rgba(163,163,163, .5)"/> </svg>
                            <ul
                                x-cloak
                                x-show.transition.origin.top.left.duration.500ms="isOpen"
                                @click.away="isOpen= false"
                                @keydown.escape.window="isOpen = false"
                                class="absolute w-44 text-left font-semibold bg-white shadow-dialog rounded-xl py-3 ml-6">
       ...
       <div class="flex items-center space-x-4 ml-6">
           <div
               ...
               <button @click="isOpen= !isOpen" type="submit"
                       class="flex items-center justify-center text-white w-50 h-11 text-sm bg-blue
                   ...
                   <form action="#" class="space-y-4 px-4 py-6">
                      ...
                      "     placeholder="Go ahead, don't by shy. Share your thoughts..."></textarea>
                       ...
                       <div class="flex items-center space-x-3">
                           <button type="submit"
                                   class="flex items-center justify-center text-white w-1/2 h-11 text-sm bg-blue
                                   font-semibold rounded-xl border border-blue hover:bg-blue-hover transition
                                   duration-150 ease-in px-6 py-3 mr-5">
          ...
          <div
              ...
              <button
                  @click="isOpen= !isOpen"
                  type="button"
                      class="flex items-center justify-center w-30 h-11 text-sm bg-gray-200 font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3"
              >
              ...
              <div
                  ...
                  <form action="#" class="space-y-4 px-4 py-6">
                      <div class="space-y-2">
                          <div>
                              <label class="inline-flex items-center">
                                  <input class="form-radio bg-gray-200 text-black border-none" type="radio" checked="" name="radio-direct" value="1">
                          ...
                          <div>
                              <label class="inline-flex items-center">
                                  <input class="form-radio bg-gray-200 text-yallow border-none" type="radio" name="radio-direct" value="3">
                      ...
                      <div class="">
                          <textarea name="comment_update" id="comment_update" cols="30" rows="3" class="w-full text-sm bg-gray-100 rounded-xl placeholder-gray-900 border-none px-4 py-2"
                      ...
                      <div class="flex items-center justify-between space-x-3">
                          ...
                          <button type="submit"
                                  class="flex items-center justify-center text-white w-1/2 h-11 text-xs bg-blue font-semibold rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3"
                          >
                      ...
                      <div>
                          <label class="font-normal inline-flex items-center">
                              <input class="form-checkbox rounded bg-gray-200" name="notify_votes" type="checkbox" checked="">
                              <span class="ml-2">Notify all votes</span>
                          </label>
                      </div>
                  </form>
              </div>
